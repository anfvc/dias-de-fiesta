        ...
        >
          ...
          <FormField name="message" errors={errors}>
            <textarea
              ...
              className={`w-full resize-none border-b-2 p-4 text-xl md:text-2xl transition-colors duration-300 outline-none ${GOLD_COLOR} ${
          ...
          <div className="button-container mt-12 flex flex-col items-center">
            <motion.button
              whileTap={{ scale: 0.98 }}
              type="submit"
              className={`w-full max-w-sm flex items-center justify-center px-8 py-5 rounded-full text-3xl font-bold text-white transition-all duration-300 shadow-xl focus:outline-none focus:ring-4 focus:ring-offset-2 focus:ring-[#B8860B]/50 ${GOLD_BG} ${
